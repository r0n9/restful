...
public class Status {
    public static enum StatusCode {
        ...
        JOB_EXISTS("job is running already, start new job fail"), NEW_JOB_START(
                "start new job success"), NO_JOB_RUNNING("no job is running"), JOB_COMPLETE(
                "job is completed"), JOB_RUNNING("job is running");
